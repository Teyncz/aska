export function createDomainRow(domain) {
    console.log(domain)
    ...
    tr.appendChild(createCell('th', domain.name, 'w-[300px] flex justify-start text-[16px] font-[300]'));
    tr.appendChild(createCell('td', domain.expiration, 'w-[175px] flex justify-start text-[16px] font-[300]'));
    tr.appendChild(createCell('td', domain.host, 'w-[150px] flex justify-start text-[16px] font-[300]'));
    tr.appendChild(createCell('td', domain.redirection, 'w-[225px] flex justify-start text-[16px] font-[300]'));
    tr.appendChild(createCell('td', domain.apache_config, 'w-[250px] flex justify-start text-[16px] font-[300]'));
